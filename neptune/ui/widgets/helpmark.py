...
class HelpMark(QWidget):
    ...
    def __init__(self, text: str = '', parent=None):
        ...
        # Qt only sends hover events to a widget that asks for them; without this the
        # mark never brightens and the tooltip depends purely on mouse tracking.
    ...
    def set_text(self, text: str) -> None:
        ...
        # A plain tooltip string is laid out on one enormous line. Qt wraps rich text at
        # the width its stylesheet gives it, so the hint arrives as a readable block
        # rather than a sentence running off the edge of the screen.
    ...
    def paintEvent(self, _event) -> None:
        ...
        # Inset by the pen width so the ring is not clipped by the widget edge.
