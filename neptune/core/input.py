...
KEY_TABLE = [
    ('X', 0x58), ('Z', 0x5A), ('C', 0x43), ('V', 0x56), ('B', 0x42), ('N', 0x4E),
    ('F', 0x46), ('G', 0x47), ('H', 0x48), ('J', 0x4A), ('K', 0x4B), ('L', 0x4C),
    ('Q', 0x51), ('E', 0x45), ('R', 0x52), ('T', 0x54), ('Y', 0x59), ('U', 0x55),
    ('Left Ctrl', 0xA2), ('Right Ctrl', 0xA3), ('Left Alt', 0xA4), ('Right Alt', 0xA5),
    ('Left Shift', 0xA0), ('Space', 0x20), ('Caps Lock', 0x14), ('Tab', 0x09),
    ...
    ('Numpad 8', 0x68), ('Numpad 9', 0x69), ('Numpad .', 0x6E),
    ('Mouse 3', 0x04), ('Mouse 4', 0x05), ('Mouse 5', 0x06),
]
...
PAD_TABLE = [
    ...
    ('Left Trigger', 0x10000), ('Right Trigger', 0x20000),
]
